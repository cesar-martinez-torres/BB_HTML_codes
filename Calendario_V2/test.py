...
class CalendarBuilderApp(tk.Tk):
    ...
    # ✅ CAMBIO: limpiar prefijos SOLO para PDF
    def _pdf_titles_for_date(self, date_str: str) -> list[str]:
        ...
        for e in evs_sorted:
            ...
            # Quitar prefijos técnicos solo en el PDF
            ...
            for day in range(1, rows + 1):
                ...
                if day <= last_day:
                    ...
                    if titles:
                        ...
                        # ✅ CAMBIO: evitar salto de línea en “y Tareas”
                        text = text.replace(" y Tareas", " y\u202FTareas")
